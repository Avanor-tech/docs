...
Reason for payout rejection ([getting status 6](/withdraw-statuses)) can be clarified through the support service [support@avanor.tech](mailto:support@avanor.tech).
