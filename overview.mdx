---
title: "M5 Payment Gateway API (1.0.0)"
---

## Description

Using this API, you can interact with M5 payment platform: accept payments, make payments and perform other operations supported by the platform.
...
To ensure that our API improvements do not break your integration, please consider the following list of backward compatible changes that can occur without increasing your M5 API version number.
