...
6. After the payment is made or charged by the user, the Avanor tech system [sends a notification](/callbacks) to the URL of interaction with the shop, containing payment information, for more information, see [here](/api-reference/invoice-create/invoice-issue);
...
6. After payment is completed by the user, the Avanor tech system [sends a notification](/callbacks) to the shop's interaction URL, with information about the blocking of funds;
...
9. Avanor tech system [will send a notification](/callbacks) to the URL of the interaction of the shop with the final status regarding the confirmation of funds withdrawal.
